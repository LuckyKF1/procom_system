...
- การลบข้อมูลทั้งหมด (`delete_*`), `add_shipping` และ `update_sale_status` รับเฉพาะ POST + CSRF token เท่านั้น
## โครงสร้างไฟล์หลัก
...
- ถ้าเจอ bug ให้เริ่มจาก:
  ...
  2. รัน `docker-compose exec web python3 manage.py migrate`
