...
def sales_report(request):
    ...
    if search_query:
        sales = sales.filter(
            models.Q(sale_id__icontains=search_query) |
            models.Q(cus__cus_name__icontains=search_query) | # ຊື່ລູກຄ້າ
            models.Q(emp__emp_name__icontains=search_query)   # ຊື່ພະນັກງານຂາຍ
        ).distinct()
